...
class AnonymizedViewsDescription(Resource):
    """The description of the anonymized view.
    ...
    :param properties: The common properties of an anonymized view.
    :type properties:
     ~azure.mgmt.healthcareapis.models.AnonymizedViewsProperties
    """
    ...
    _attribute_map = {
        ...
        'properties': {'key': 'properties', 'type': 'AnonymizedViewsProperties'},
    }

    def __init__(self, *, kind, location: str, tags=None, etag: str=None, identity=None, properties=None, **kwargs) -> None:
        super(AnonymizedViewsDescription, self).__init__(kind=kind, location=location, tags=tags, etag=etag, identity=identity, **kwargs)
